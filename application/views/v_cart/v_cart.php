                            ...
                            <table class="table-shopping-cart">
                                ...
                                <?php foreach ($cart as $key) : ?>
                                    <tr class="table_row">
                                        ...
                                        <td class="text-left column-2"><?php echo $key['nama_produk'] ?></td>
                                        <td class="text-left"><?php echo $key['total'] ?>x Rp<?php echo number_format($key['harga'], 0, ',', ','); ?></td>
                                        <td class="column-4 ">
                                        </td>
                                        <td class="column-5 ">
                                            <button class="js-hapus flex-c-m stext-100 cl0 size-100 bg5 bor2 hov-btn1 p-lr-15 trans-04 " data-id-keranjang="<?php echo $key['id_keranjang'] ?>">
                                                Hapus
                                            </button><br>

                                            <button class="js-tambah flex-c-m stext-100 cl0 size-100 bg1 bor2 hov-btn1 p-lr-15 trans-04 " data-id-keranjang="<?php echo $key['id_produk'] ?>" data-id-penjual="<?php echo $key['id_penjual'] ?>">Tambah</button>
                                        </td>
