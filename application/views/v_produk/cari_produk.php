    ...
    <header class="header-v4">
            ...
            <div class="wrap-menu-desktop how-shadow1">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m">
                        ...
                        <?php if (($sess)) { ?>
                            <a href="<?= base_url('Auth/logout') ?>" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">Logout</a>
                        <?php } else { ?>
                            <a href="<?= base_url('Auth/index') ?>" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
                                Login
                            </a>
                        <?php } ?>
                    </div>
        ...
        <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
            <div class="container-search-header">
                ...
                <form action="<?= base_url('c_produk/cari_produk') ?>" method="post" class="wrap-search-header flex-w p-l-15">
                ...
                <ul class="header-cart-wrapitem w-full">
                    <li class="header-cart-item flex-w flex-t m-b-12">
                        <div class="header-cart-item-img">
                            <img src="<?= base_url('asset'); ?>/images/item-cart-01.jpg" alt="IMG">
                        </div>
                    ...
                    <li class="header-cart-item flex-w flex-t m-b-12">
                        <div class="header-cart-item-img">
                            <img src="<?= base_url('asset'); ?>/images/item-cart-02.jpg" alt="IMG">
                        </div>
                    ...
                    <li class="header-cart-item flex-w flex-t m-b-12">
                        <div class="header-cart-item-img">
                            <img src="<?= base_url('asset'); ?>/images/item-cart-03.jpg" alt="IMG">
                        </div>
            ...
            <div class="flex-w flex-sb-m p-b-52">
                ...
                <div class="dis-none panel-search w-full p-t-10 p-b-15">
                    <div class="bor8 dis-flex p-l-15">
                        ...
                        <form action="<?= base_url('c_produk/cari_produk') ?>" method="post">
                            <input class="plh3" type="text" name="keyword" placeholder="Cari Produk...">
                            ...
                            <div class="card-sl">
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        ...
                                        <form action="<?= base_url('c_produk/lihat_produk_guest'); ?>" method="post">
                                            <input type="hidden" name="id_produk" value="<?php echo $key['id_produk'] ?>">
                                            <button class="btn btn-outline-white block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04" type="submit" name="pilih">Lihat Produk</button>
                                        </form>
                                    ...
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            <form action="<?= base_url('c_produk/lihat_produk_guest'); ?>" method="post">
                                                <input type="hidden" name="id_produk" value="<?php echo $key['id_produk'] ?>">
                                                <button class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" type="submit" name="pilih"><?php echo $key['nama_produk'] ?> </button>
                                            </form>
                                            <a href="" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                            </a>
                                            <span class="stext-105 cl3">
                                                Rp<?php echo $key['harga'] ?>
                                            </span>
                                            <br>
                                        </div>
                                    </div>
                            ...
                            <div class="card-sl">
                                <div class="block2">
                                    <div class="block2-pic hov-img0">
                                        ...
                                        <a href="<?php echo base_url('c_produk/lihat_produk?id_produk=' . urlencode($key['id_produk'])); ?>" method="post" class="btn btn-outline-white block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">Lihat Produk</a>
                                    </div>
                                    <div class="block2-txt flex-w flex-t p-t-14">
                                        <div class="block2-txt-child1 flex-col-l ">
                                            <form action="<?= base_url('c_produk/lihat_produk'); ?>" method="post">
                                                <input type="hidden" name="id_produk" value="<?php echo $key['id_produk'] ?>">
                                                <button class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6" type="submit" name="pilih"><?php echo $key['nama_produk'] ?> </button>
                                            </form>
                                            <a href="" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                ...
                <ul id="pagination" class="pagination justify-content-center">
                    <li class="page-item" id="prevPage">
                        <a class="page-link" href="#" aria-label="Previous">
                            <span class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04" aria-hidden="true">&laquo; Previous</span>
                        </a>
                    </li>
                    <li class="page-item" id="nextPage">
                        <a class="page-link" href="#" aria-label="Next">
                            <span class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04" aria-hidden="true">Next &raquo;</span>
                        </a>
                    </li>
                </ul>
            </nav>
                                ...
                                <div class="slick3 gallery-lb">
                                    <div class="item-slick3" data-thumb="images/product-detail-01.jpg">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="<?= base_url('asset'); ?>/images/product-detail-01.jpg" alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= base_url('asset'); ?>/images/product-detail-01.jpg">
                                    ...
                                    <div class="item-slick3" data-thumb="images/product-detail-02.jpg">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="<?= base_url('asset'); ?>/images/product-detail-02.jpg" alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= base_url('asset'); ?>/images/product-detail-02.jpg">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item-slick3" data-thumb="images/product-detail-03.jpg">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="<?= base_url('asset'); ?>/images/product-detail-03.jpg" alt="IMG-PRODUCT">

                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= base_url('asset'); ?>/images/product-detail-03.jpg">
                                                <i class="fa fa-expand"></i>
                                            </a>
                                        </div>
                                    </div>
