								...
								<div class="slick3 gallery-lb">
									...
									<?php if (file_exists($foto_path)) : ?>
										<div class="item-slick3" data-thumb="../asset/images/<?php echo $key['foto_produk'] ?>">
											<div class="wrap-pic-w pos-relative">
												<img src="../asset/../asset/images/<?php echo $key['foto_produk'] ?>" alt="IMG-PRODUCT">
									...
									<?php else : ?>
										<div class="item-slick3" data-thumb="http://localhost/pss_penjual/assets/produk/<?php echo $key['foto_produk'] ?>">
											<div class="wrap-pic-w pos-relative">
												<img src="http://localhost/pss_penjual/assets/produk/<?php echo $key['foto_produk'] ?>" alt="IMG-PRODUCT">
												<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/product-detail-01.jpg">
													<i class="fa fa-expand"></i>
												</a>
											</div>
								...
								<div class="p-t-33">
									...
									<div class="flex-w flex-r-m p-b-10">
										<div class="size-204 flex-w flex-m respon6-next">
											...
											<!-- <form action="<?= base_url('c_cart/cart'); ?>" method="post">
											...
											<a href="<?= base_url('Auth') ?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
												Masukan Keranjang
											</a>
											<!-- <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
											Masukan Keranjang
