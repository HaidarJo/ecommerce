            ...
            <div class="row">
                <div class="col-sm-10 col-lg-7 col-xl-20 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        <form action="<?= base_url('c_order/tagihan'); ?>" method="post">
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                    <p class="stext-111 cl6 p-t-2">
                                        Tidak ada jasa pengiriman yang tersedia. Mohon lengkapi alamat anda.
                                    </p>
                                            ...
                                            <select class="js-select2" name="kabupaten">
                                                ...
                                                <?php if ($kota) : ?>
                                                    <?php foreach ($kota->rajaongkir->results as $kab) : ?>
                                                        <option value="<?php echo $kab->city_id ?>"><?php echo $kab->city_name ?></option>
                                                    <?php endforeach ?>
                                                <?php endif ?>
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-209">
                                    ...
                                    <span class="stext-112 cl8">
                                        <?php foreach ($total_harga as $key) : ?>
                                            Subtotal : Rp <?php echo number_format($key['total'], 0, ',', ','); ?>
                                        <?php endforeach ?>
                                    </span>
