                ...
                <div class="col-sm-10 col-lg-7 col-xl-20 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            <div class="size-217 p-r-18 p-r-0-sm w-full-ssm">
                                <div class="p-t-15">
                                    <div class="flex-w flex-t ">
                                        <div class="size-204 w-full-ssm">
                                            ...
                                            <p class="stext-111 cl6 p-t-2">
                                                <span class="stext-110 cl2">
                                                    ...
                                                    <?php foreach ($tagihan as $id) :  ?>
                                                        <?php echo ($id_tagihan = $id['id_tagihan']) ?> <?php $counter++; ?> <?php if ($counter >= 1) break; ?>
                                                    <?php endforeach ?>
                                                </span>
                                            </p>
                                        </div>
                                    ...
                                    <br>
                                    <label class="stext-111 cl6 p-t-2" for="tgl_pembayaran">Tanggal dan Jam Pembayaran</label>
                                    <input type="datetime-local" id="tgl_pembayaran" name="tgl_pembayaran" class="form-control" required>
                                    <br>
                                    <label class="stext-111 cl6 p-t-2" for="bukti_pembayaran">Bukti Pembayaran</label>
                        ...
                        <input type="submit" value="Simpan" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
