...
<body class="animsition">
	...
	<header>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="../asset/images/icons/pasar_transparent.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				...
				<form class="wrap-search-header flex-w p-l-15">
					...
					<input class="plh3" type="text" name="Cari" placeholder="Cari...">
				</form>
			</div>
		</div>
	</header>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(../asset/images/bgnd1.jpg);">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="../asset/images/baju.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="../asset/images/lukisan.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="../asset/images/lainnya.jpg" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search-product" placeholder="Cari">
					</div>
				</div>
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								...
								<!-- <form action="<?= base_url('c_produk/lihat_produk'); ?>" method="post">
									...
									<input type="hidden" name="id_penjual" value="<?php echo $key['id_penjual'] ?>">
			...
			<!-- <div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../asset/images/<?php echo $foto_produk ?>" alt="IMG-PRODUCT">
							...
							<div class="p-l-25 p-r-30 p-lr-0-lg">
								<div class="wrap-slick3 flex-sb flex-w">
									...
									<div class="slick3 gallery-lb">
										<div class="item-slick3" data-thumb="../asset/images/<?php echo $key['foto_produk'] ?>">
											<div class="wrap-pic-w pos-relative">
												<img src="../asset/images/<?php echo $key['foto_produk'] ?>" alt="IMG-PRODUCT">

												<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="../asset/images/<?php echo $key['foto_produk'] ?>">
