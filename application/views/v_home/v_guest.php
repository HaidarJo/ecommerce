...
<body class="animsition">
	...
	<header>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="<?= base_url('asset'); ?>/images/icons/pasar_transparent.png" alt="IMG-LOGO"></a>
			</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(<?= base_url('asset'); ?>/images/bgnd1.jpg);">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<?= base_url('asset'); ?>/images/baju.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= base_url('asset'); ?>/images/lukisan.jpg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= base_url('asset'); ?>/images/lainnya.jpg" alt="IMG-BANNER">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								...
								<div class="block2-txt-child2 flex-r p-t-3">
									<a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
										<img class="<?= base_url('asset'); ?>/icon-heart1 dis-block trans-04" src="<?= base_url('asset'); ?>/images/icons/icon-heart-01.png" alt="ICON">
										<img class="<?= base_url('asset'); ?>/icon-heart2 dis-block trans-04 ab-t-l" src="<?= base_url('asset'); ?>/images/icons/icon-heart-02.png" alt="ICON">
									</a>
								</div>
							</div>
						</div>
