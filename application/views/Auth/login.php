...
<head>
    ...
    <!--===============================================================================================-->
    <!-- Font Icon -->
    <link rel="stylesheet" href="<?= base_url('asset'); ?>/form/fonts/material-icon/css/material-design-iconic-font.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="<?= base_url('asset'); ?>/form/css/style.css">
    <!--  -->
    <style>
        body {
...
<body>
                    ...
                    <form action="<?php echo base_url('auth') ?>" method="post">
                        ...
                        <div class="register">
                            <div class="text-center">
                                <p><a href="<?php echo base_url('auth/signup') ?>">Buat Akun Baru</a></p>
                            </div>
                        </div>
    ...
    <!--===============================================================================================-->
    <script src="<?= base_url('asset'); ?>/form/vendor/jquery/jquery.min.js"></script>
    <script src="<?= base_url('asset'); ?>/form/js/main.js"></script>
    <!--===============================================================================================-->
</body>
