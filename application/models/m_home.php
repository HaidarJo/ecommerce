...
class m_home extends CI_Model
{
    ...
    function total_harga($id_user)
    {
        $query = $this->db->query("select (SUM(1*harga)) as total from tb_keranjang INNER JOIN tb_produk ON tb_keranjang.id_produk = tb_produk.id_produk where tb_keranjang.id_pembeli = $id_user;");
